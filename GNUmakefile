...
override USERLAND_PROGS := init cat sh ls tree forktest exectest crashtest usercopytest pipetest sprintftest malloctest clonetest shmtest mousetest fbtest
